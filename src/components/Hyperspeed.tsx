...
class App {
  ...
  constructor(container: HTMLElement, options: HyperspeedOptions) {
    ...
    this.camera.position.y = 12; // Moved up from 8 to 12 for higher positioning
    ...
    if (typeof this.options.distortion === 'object' && this.options.distortion.getJS) {
      ...
      this.camera.lookAt(
        new THREE.Vector3(
          ...
          this.camera.position.y + distortion.y - 2, // Adjusted to look slightly lower when camera is higher
